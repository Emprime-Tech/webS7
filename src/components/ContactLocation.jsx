...
export default function ContactLocation() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-[5] bg-gradient-to-l from-black/60 via-black/40 to-transparent" />
      ...
      <div ref={mapRef} className="w-full max-w-5xl relative z-10 pb-8">
        <h2 className="text-3xl text-[#e85c0d] mb-8">Our Location</h2>

        <div className="w-full h-[400px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-[#1a1008]">
          {mapInView ? (
            <iframe
              title="S7 Padel location"
