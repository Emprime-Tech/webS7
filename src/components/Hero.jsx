...
export default function Hero() {
  return (
    <section
      id="home"
      className="perf-section relative min-h-screen w-full flex flex-col justify-center p-8 md:p-16 lg:p-24 text-white overflow-hidden"
    >
      <OptimizedImage
        src={bg}
        alt=""
      ...
      <div className="w-full max-w-2xl flex flex-col items-start space-y-6 z-10">
        ...
        <div className="flex flex-col space-y-4 pt-4">
          <button
            type="button"
            className="h-12 px-8 rounded-xl border border-white/50 text-sm bg-black/40 text-[#e85c0d] hover:bg-black/60"
          >
            Book The Court
          </button>
